...
class Character extends FNFSprite
{
	...
	function setCharacter(character:String)
	{
		...
		switch (curCharacter)
		{
			...
			case 'cecilia':
				tex = Paths.getSparrowAtlas('characters/flutter-cecilia');
				frames = tex;
				animation.addByPrefix('idle', 'CeciliaIdle', 24, false);
				animation.addByPrefix('singUP', 'CeciliaSingUp', 24);
				animation.addByPrefix('singRIGHT', 'CeciliaSingRight', 24);
				animation.addByPrefix('singDOWN', 'CeciliaSingDown', 24);
				animation.addByPrefix('singLEFT', 'CeciliaSingLeft', 24);
